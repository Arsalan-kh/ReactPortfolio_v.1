...
const Projects = () => {
  ...
  const Cardrender=(card,index)=>{
    ...
    <div class="">
      <div class="bg-black card m-2 cursor-pointer border-4 border-gray-800 rounded-lg hover:shadow-md hover:border-opacity-0 transform hover:-translate-y-1 transition-all duration-200">
